...
we'll do that later.
1. You'll need to enter your credit card info, even though this is a
free tier.
1. Follow the confirmation process to activate your account.
1. Sign into the Console
1. It may take awhile for your new account to become active.
1. You will receive an email when your account is activated
...
1. Use the Alexa Skill Kit portal to configure our Alexa skill
...
1. Select ***lambda*** in compute services.
1. Select the ***Skip*** button in the bottom right to skip
...
1. Set Runtime to ***node.js***
1. Set Code entry type to ***Upload a .ZIP file***
1. Click the ***Upload*** button, and select the archive file
...
1. You will be prompted for an IAM role if not previously done
...
1. Copy the ARN information displayed in the upper right.
...
1. Select the ***APPS & SERVICES*** tab
1. Select ***Alexa*** in the horizontal menu near the top.
1. Select the ***Alexa Skills Kit*** Get Started button.
You may want to bookmark this page.
1. Select ***Add a New Skill***
1. Provide a name of your choosing (eg. "HelloWorld")
1. Provide the invocation words (eg. "hello world")
1. Provide a version number of your choosing (eg. "1.0")
1. Set the Endpoint to ***Lambda ARN (Amazon Resource Name)***
1. Copy into the Endpoint field the ARN that you previously copied.
...
1. Ignore the slot section for this skill.
1. Copy and paste the contents of the SampleUtterances.txt file from
